...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { image_url: @sponsor.image_url, text: @sponsor.text, title: @sponsor.title, url: @sponsor.url }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { image_url: @sponsor.image_url, text: @sponsor.text, title: @sponsor.title, url: @sponsor.url }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
